...
const { BaseExpenseGenerationStrategy } = await import('../../../src/strategies/expenseGeneration/baseStrategy.js');
const { ImmediateExpenseStrategy } = await import('../../../src/strategies/expenseGeneration/immediateStrategy.js');
const { RecurringExpenseStrategy } = await import('../../../src/strategies/expenseGeneration/recurringStrategy.js');
const { AutomaticDebitExpenseStrategy } = await import('../../../src/strategies/expenseGeneration/automaticDebitStrategy.js');
const { InstallmentExpenseStrategy } = await import('../../../src/strategies/expenseGeneration/installmentStrategy.js');
