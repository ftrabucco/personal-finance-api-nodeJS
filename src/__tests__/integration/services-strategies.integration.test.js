...
const { GastoRecurrenteService } = await import('../../services/gastoRecurrente.service.js');
const { DebitoAutomaticoService } = await import('../../services/debitoAutomatico.service.js');
const { GastoUnicoService } = await import('../../services/gastoUnico.service.js');
const { ComprasService } = await import('../../services/compras.service.js');
const { GastoGeneratorService } = await import('../../services/gastoGenerator.service.js');
